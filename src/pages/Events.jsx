        ...
        return (
          <>
            <div className="container min-w-full min-h-screen flex flex-col justify-center items-center relative">
              ...
              <h1 className="font-dreamland xl:text-[120px] lg:text-[100px] md:text-[80px] sm:text-[60px] text-[60px] text-center text-white">
                {day.title}
              </h1>
              <p className="text-main_primary text-center font-black text-[1rem]">
                Scroll Down
              </p>
            </div>
