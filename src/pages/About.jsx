            ...
            <div className="h-fit relative pt-4 px-2 xl:px-20 bg-soothing_black">
                ...
                <div className="font-chakra text-base py-8 leading-[5px] xl:mt-4">
                    ...
                    >
                        ...
                        Bhaskaracharya College of Applied Sciences, is an exiting event that celebrates
                        the technical expertise and artistic talents of aspiring students.
                        ...
                        students and artists. From technical competitions to cultural events{" "}
                        <b>SRIJAN'24</b> offers a diverse range of activities that cater to
                ...
                >
                    <p className="text-white text-base xl:text-xl font-chakra font-medium">
                        ...
                        in various disciplines of sciences and applied sciences. Ranked 
                        22nd among colleges in all over India by the National Institutional
