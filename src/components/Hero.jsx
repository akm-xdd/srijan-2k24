...
import "./Hero.css";
const eventDate = new Date('2024-03-8');

export default function Hero() {
  return (
    <>
      <div className="relative">
        <video src={'/assets/background.mp4'} autoPlay loop muted className="min-w-full min-h-screen z-[-1] object-cover brightness-[20%]" />
